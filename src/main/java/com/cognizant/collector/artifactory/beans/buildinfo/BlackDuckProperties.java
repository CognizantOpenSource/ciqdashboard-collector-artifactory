...
public class BlackDuckProperties {
    ...
    @JsonProperty("autoCreateMissingComponentRequests")
    public Boolean autoCreateMissingComponentRequests;
    @JsonProperty("autoDiscardStaleComponentRequests")
    public Boolean autoDiscardStaleComponentRequests;
    @JsonIgnore
